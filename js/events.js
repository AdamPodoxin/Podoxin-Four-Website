...
function loadEventsFromJSON(jsonData) {
    const dataArray = Array.from(JSON.parse(jsonData));
...
function createEventFromJSON(element) {
    ...
    let venueHTML = "<td><a href='" + element.venueSite + "' target='_blank' class='hyperlink'>" + venueComponents[0] + "</td >";
    ...
    if (element.ytId != "") {
        ...
        ytHTML = "<td><img src='../img/yt_icon_rgb.png' width='46px' height='32px' onclick='OpenModal(" + modalId + ")' title='Click to view video'></td>";
    }
